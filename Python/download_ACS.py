'''
Python functions to download American Community 
Survey and prep the data
...
##############################################################################
# Functions to download data and prep data given fields
...
def prop_prep(data, num, den, names):
    ...
    res_df.columns = ['GEOID'] + names
    return res_df

##############################################################################

##############################################################################
# Example of downloading Texas data and census tract info
